...
const StockPriceTrends = () => {
    ...
    const prepareChartData = (data) => {
        ...
        const datasets = [
              {
                  label: "Average Price",
                  data: data.map((item) => parsePrice(item[5])), // Assuming avg_price is at index 2
                  borderColor: "#0ac4ff",
                  borderWidth: 2,
                  tension: 0.3,
                  pointRadius: 0,
              ...
              {
                  label: "Last Price",
                  data: data.map((item) => parsePrice(item[2])), // Assuming last_price is at index 3
                  borderColor: "#ff6f61",
                  borderWidth: 2,
                  tension: 0.3,
                  pointRadius: 0,
              ...
              {
                  label: "Max Price",
                  data: data.map((item) => parsePrice(item[3])), // Assuming max_price is at index 4
                  borderColor: "#28a745",
                  borderWidth: 2,
                  tension: 0.3,
                  pointRadius: 0,
              ...
              {
                  label: "Min Price",
                  data: data.map((item) => parsePrice(item[4])), // Assuming min_price is at index 5
                  borderColor: "#ffc107",
                  borderWidth: 2,
                  tension: 0.3,
                  pointRadius: 0,
